    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                e = '<li><a href="#{0}" id="{2}" type="{3}" role="menuitem"><i class="{1}"></i></a></li>',
                f = "";
            b.forceMoveForward || (f += e.format("previous","fa-solid fa-angle-left" )), f += e.format("next","fa-solid fa-angle-right"), b.enableFinishButton && (f += e.format("finish", b.labels.finish,"finish","submit")), b.enableCancelButton && (f += e.format("cancel", b.labels.cancel)), a.append(d.format(b.actionContainerTag, b.clearFixCssClass, b.labels.pagination, f)), D(a, b, c), A(a, b, c)
        }
    }
