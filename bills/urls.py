...
urlpatterns = [
  ...
  path('invoice/update/<int:pk>',login_required(InvoiceUpdateView.as_view()), name='invoiupdate'),
...
# Proforma urls 
  path('proforma/',login_required(ProformaCreateView.as_view()), name='proformacreate'),
  path('proforma/update/<int:pk>',login_required(ProformaUpdateView.as_view()), name='invoiupdate'),
